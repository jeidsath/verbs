module Verbs
  module Conjugator
    ...
    def conjugate(infinitive, options = {})
      ...
      check_for_improper_constructions(infinitive, tense, person, voice, mood, aspect)
    ...
    def check_for_improper_constructions(infinitive, tense, person, voice, mood, aspect)
